            ...
            <div className="directory-column contact-col">
              ...
              <div className="contact-outro-card">
                <div className="contact-item">
                  ...
                  <a href={`tel:${BRAND_INFO.phonePlaceholder}`} className="contact-text-link">
                    {BRAND_INFO.phonePlaceholder}
                  </a>
                </div>
                <div className="contact-item">
                  <Mail size={15} className="gold-icon-outro" />
                  <a href={`mailto:${BRAND_INFO.emailPlaceholder}`} className="contact-text-link">
                    {BRAND_INFO.emailPlaceholder}
                  </a>
                </div>
                <div className="contact-item">
                  <Clock size={15} className="gold-icon-outro" />
                  <span>{BRAND_INFO.hoursPlaceholder}</span>
                </div>
                <div className="contact-item">
                  <MapPin size={15} className="gold-icon-outro" />
                  <span>{BRAND_INFO.serviceArea}</span>
                </div>
